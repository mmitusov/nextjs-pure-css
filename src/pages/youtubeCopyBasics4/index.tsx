...
//Однако, при желании, прараметры центровки елемента можно прописать и внутри елемента - align-self: flex-start/start/end/center/stretch; (no 'display: flex;' needed)
