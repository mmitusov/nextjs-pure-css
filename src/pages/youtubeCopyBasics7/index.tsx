import thumStyles from '@/styles/youtubeCopy7.module.css'
...
const YouTubeCopy7 = () => {
  ...
  <>
    ...
    <main className={`${thumStyles.mainTag}`}>
      <p className={`${thumStyles.pTag}`}> <strong>Responsive design, media query - lesson</strong> </p>
      ...
      <div className={`${thumStyles.header1}`}>
        ...
        <div className={`${thumStyles.headerRight1}`}>
          <div className={`${thumStyles.uploadButton}`} >
            ...
            <div className={`${thumStyles.hoverToolTip}`}>Upload video</div>
          </div>
          <div className={`${thumStyles.youtubeAppsButton}`} >
            <Image className={`${thumStyles.youtubeAppsIcon}`} src={icon6} alt=''/>
            <div className={`${thumStyles.hoverToolTip}`}>Your apps</div>
          </div>
          <div className={`${thumStyles.notificationsIconConteiner}`}> 
            ...
            <div className={`${thumStyles.hoverToolTip}`}>Notifications</div>
          </div>
