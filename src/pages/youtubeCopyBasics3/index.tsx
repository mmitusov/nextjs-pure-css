import thumStyles from '@/styles/youtubeCopy2.module.css'
...
//P.S. Это касается класической связки CSS+HTML. Но я заметил используя Next.js пока таких проблем не возникало
//И как решение этого всего - мы можем использовать CSS Grid подход
